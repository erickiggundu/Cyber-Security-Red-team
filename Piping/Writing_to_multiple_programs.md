...
# Method of Solve
Run /challenge/hack and use tee with output process substitution 
to send its output to both /challenge/the and /challenge/planet simultaneously:
